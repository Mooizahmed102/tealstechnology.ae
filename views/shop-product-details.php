...
<body>
 ...
 <?php include_once("includes/header.php")?>
  ...
  <!-- Start Hero -->
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/shop_hero_bg.jpeg">
    <div class="container">
      <div class="cs-page_heading_in">
        <h1 class="cs-page_title cs-font_50 cs-white_color">Shop</h1>
      ...
      <div class="col-lg-6">
        <div class="cs-single-product-details">
          ...
          <div class="cs-single_product-price_review">
            <div class="cs-single_product_price cs-accent_color cs-primary_font cs-semi_bold">$20.00</div>
            <div class="cs-rating cs-size_sm cs-accent_color" data-rating="4">
              <div class="cs-rating_bg">
              ...
              <div class="cs-rating_percentage">
          ...
          <div class="cs-quantity_and_btn">
            <div class="cs-quantity">
              <button class="cs-quantity_button cs-increment"><i class="fa-solid fa-angle-up"></i></button>
              <span class="cs-quantity_input">1</span>
              <button class="cs-quantity_button cs-decrement"><i class="fa-solid fa-angle-down"></i></button>
            </div>
            <a href="#" class="cs-product_btn cs-semi_bold">Add to cart</a>
          </div>
    ...
    <div class="cs-product_meta_info">
      <div class="cs-tabs cs-style1">
        ...
        <div class="cs-tab_body">
          ...
          <div class="cs-tab active" id="tab_3">
            <ul class="cs-client_review_list">
              <li>
                <div class="cs-client_review">
                  <div class="cs-review_media">
                    <div class="cs-review_media_thumb"><img src="assets/img/avatar_2.png" alt="Avatar"></div>
                    <div class="cs-review_media_right">
                      <div class="cs-rating cs-size_sm cs-accent_color" data-rating="5">
                        <div class="cs-rating_bg">
                          <i class="fa-regular fa-star"></i>
                          <i class="fa-regular fa-star"></i>
                          <i class="fa-regular fa-star"></i>
                      ...
                      <p class="m-0 cs-white_color cs-semi_bold">Zhon Abony</p>
                    </div>
                  </div>
                  <div class="cs-review_posted_by">August 12, 2023</div>
                  <div class="cs-review_text">I recently purchased the Arino T-shirts and I'm thoroughly impressed. The sound quality is exceptional, the wireless connectivity is seamless, and the noise cancellation technology is a standout feature. They're a bit pricey, but well worth the investment. Highly recommend.</div>
                </div>
              </li>
            </ul>
            <div class="cs-height_85 cs-height_lg_50"></div>
            <p class="m-0">Your email address will not be published. Required fields are marked *</p>
            <div class="cs-height_20 cs-height_lg_20"></div>
            <div class="cs-input_rating_wrap">
              <p>Your rating  *</p>
              <div class="cs-input_rating cs-accent_color" data-rating="0">
                <i class="fa-regular fa-star"></i>
                <i class="fa-regular fa-star"></i>
                <i class="fa-regular fa-star"></i>
                <i class="fa-regular fa-star"></i>
            ...
            <form class="row">
              <div class="col-lg-12">
                <textarea cols="30" rows="10" class="cs-form_field cs-radius_5" placeholder="Write your review *"></textarea>
                <div class="cs-height_25 cs-height_lg_25"></div>
              </div>
              <div class="col-lg-6">
                <input type="text" class="cs-form_field cs-radius_5" placeholder="Your name *">
                <div class="cs-height_25 cs-height_lg_25"></div>
              </div>
              <div class="col-lg-6">
                <input type="text" class="cs-form_field cs-radius_5" placeholder="Your email *">
                <div class="cs-height_25 cs-height_lg_25"></div>
              </div>
              <div class="col-lg-12">
                ...
                <div class="cs-height_40 cs-height_lg_30"></div>
                <button class="cs-product_btn" type="submit">
                  Submit
                </button>
              </div>
            </form>
  ...
  <div class="cs-height_150 cs-height_lg_80"></div>
  <!-- Start Footer -->
  <footer class="cs-fooer cs-footer_dark_bg_1">
