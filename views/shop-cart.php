  ...
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/shop_hero_bg.jpeg">
    <div class="container">
      <div class="cs-page_heading_in">
        <h1 class="cs-page_title cs-font_50 cs-white_color">Cart</h1>
    ...
    <div class="row">
      <div class="col-xl-8">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-center">
                  <button class="cs-cart-table-close"><i class="fa-solid fa-xmark"></i></button>
                </td>
              </tr>
              <tr>
                <td>
        ...
        <div class="cs-cart-offer">
          <div>
            <form action="#" class="cs-coupon-doce-form">
              <input type="text" placeholder="Coupon Code">
              <button class="cs-product_btn cs-color1 cs-semi_bold">Update Cart</button>
            </form>
          </div>
          <div>
            <button class="cs-product_btn cs-semi_bold">Update Cart</button>
          </div>
        </div>
