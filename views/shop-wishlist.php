 ...
 <?php include_once("includes/header.php")?>
  ...
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/shop_hero_bg.jpeg">
    <div class="container">
      <div class="cs-page_heading_in">
        <h1 class="cs-page_title cs-font_50 cs-white_color">Wishlist</h1>
  ...
  <div class="container">
    <div class="table-responsive">
      <table class="cs-cart_table cs-size1">
        <thead>
          <tr>
            <th>
        ...
        <tbody>
          <tr>
            ...
            <td class="text-end"><a href="#" class="cs-product_btn cs-semi_bold">Add to Cart</a></td>
          </tr>
          <tr>
            <td>
              <div class="form-check">
    ...
    <div class="cs-cart-offer">
      <div class="cs-cart-offer-col">
        <form action="#" class="cs-coupon-doce-form">
          <select class="cs-shop-input m-0">
            <option value="States">Actions</option>
            <option value="Kingdom">Add to Cart</option>
            <option value="Kanada">Remove</option>
          </select>
          <button class="cs-product_btn cs-color1 cs-semi_bold">Apply Action</button>
        </form>
      </div>
      <div class="cs-cart-offer-col">
        <button class="cs-product_btn cs-semi_bold">Add Selected to Cart</button>
        <button class="cs-product_btn cs-semi_bold">Add All to Cart</button>
      </div>
    </div>
  </div>
  <div class="cs-height_150 cs-height_lg_80"></div>
