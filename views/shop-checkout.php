...
<body>
 ...
 <?php include_once("includes/header.php")?>
  ...
  <div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="assets/img/shop_hero_bg.jpeg">
    <div class="container">
      <div class="cs-page_heading_in">
        <h1 class="cs-page_title cs-font_50 cs-white_color">Checkout</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xl-7">
        <p class="cs-checkout-alert m-0">Have a coupon? <a href="">Click here to enter your code</a></p>
        <div class="cs-height_40 cs-height_lg_40"></div>
        <h2 class="cs-checkout-title">Billing Details</h2>
        <div class="cs-height_45 cs-height_lg_40"></div>
        <div class="row">
          <div class="col-lg-6">
            <label class="cs-shop-label">First Name *</label>
            <input type="text" class="cs-shop-input">
          </div>
          <div class="col-lg-6">
            <label class="cs-shop-label">Last Name *</label>
            <input type="text" class="cs-shop-input">
          </div>
          <div class="col-lg-12">
            <label class="cs-shop-label">Company name (optional)</label>
            <input type="text" class="cs-shop-input">
          </div>
          <div class="col-lg-12">
            <label class="cs-shop-label">Country / Region *</label>
            <select class="cs-shop-input">
          ...
          <div class="col-lg-12">
            <label class="cs-shop-label">Street address *</label>
            <input type="text" class="cs-shop-input" placeholder="House number and street name">
            <input type="text" class="cs-shop-input" placeholder="Apartment, suite, unit, etc (optional) ">
          </div>
          <div class="col-lg-12">
            <label class="cs-shop-label">Town / City *</label>
            <input type="text" class="cs-shop-input">
          </div>
          <div class="col-lg-12">
            <label class="cs-shop-label">State *</label>
            <select class="cs-shop-input">
          ...
          <div class="col-lg-12">
            <label class="cs-shop-label">ZIP Code *</label>
            <input type="text" class="cs-shop-input">
          </div>
          <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            <label class="cs-shop-label">Email address *</label>
            <input type="text" class="cs-shop-input">
          </div>
        </div>
        <div class="cs-height_45 cs-height_lg_45"></div>
        <h2 class="cs-checkout-title">Additional information</h2>
        <div class="cs-height_30 cs-height_lg_30"></div>
        <label class="cs-shop-label">Order notes (optional)</label>
        <textarea cols="30" rows="6" class="cs-shop-input"></textarea>
        <div class="cs-height_30 cs-height_lg_30"></div>
      </div>
      <div class="col-xl-5">
          ...
          <div class="cs-shop-card">
            ...
            <table class="cs-white_color">
              <tbody>
                ...
                <tr>
                  <td class="cs-semi_bold">Subtotal</td>
            ...
            <div class="cs-height_30 cs-height_lg_30"></div>
            <button class="cs-product_btn cs-semi_bold w-100">Procced To Checkout</button>
          </div>
                ...
                <tr>
                  <td>
                    <div class="form-check">
                      ...
                      <label class="form-check-label m-0 cs-white_color cs-semi_bold" for="flexCheckDefault">
                        Cash on delivery
                      </label>
                    </div>
                    <p class="m-0 cs-payment_text">Pay with cash upon delivery.</p>
                  </td>
                </tr>
              </tbody>
            </table>
            <div class="cs-height_25 cs-height_lg_25"></div>
            <p class="m-0 cs-payment_text">Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our <a href="">privacy policy</a>.</p>
            <div class="cs-height_20 cs-height_lg_20"></div>
            <button class="cs-product_btn cs-semi_bold w-100">Place Order</button>
          </div>
          <div class="cs-height_30 cs-height_lg_30"></div>
        </div>
      </div>
