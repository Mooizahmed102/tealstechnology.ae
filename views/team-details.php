    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6">
          <img src="assets/img/member_details_1.jpeg" alt="Member" class="cs-radius_15 w-100">
        </div>
        <div class="col-lg-6 offset-xl-1">
          <div class="cs-height_0 cs-height_lg_45"></div>
          <div class="cs-section_heading cs-style1">
            <h2 class="cs-section_title">Melon Bulgery</h2>
            <div class="cs-height_10 cs-height_lg_10"></div>
            <h3 class="cs-section_subtitle">Product Designer</h3>
            ...
            <p class="cs-m0">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium voltire doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.</p>
            <div class="cs-height_25 cs-height_lg_20"></div>
            <p class="cs-m0">Ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit.</p>
