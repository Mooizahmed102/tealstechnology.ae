  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3">
        <div class="cs-shop_sidebar">
          <div class="cs-shop_sidebar_widget">
            <form action="#" class="cs-shop_search">
              <input class="cs-shop_search_input" type="text" placeholder="Search Products...">
              <button class="cs-shop_search_btn">
                <img src="assets/img/icons/search.svg" alt="Thumb">        
              </button>
            </form>
          </div>
          <div class="cs-shop_sidebar_widget">
            <h3 class="cs-shop_sidebar_widget_title">Categories</h3>
          ...
          <div class="cs-shop_sidebar_widget">
            <h3 class="cs-shop_sidebar_widget_title">Price Filter</h3>
          ...
          <div class="cs-shop_sidebar_widget">
            <h3 class="cs-shop_sidebar_widget_title">Tags</h3>
            <ul class="cs-shop_sidebar_tag_list">
      ...
      <div class="col-lg-9">
        ...
        <div class="cs-shop_filter_wrap">
          <div class="cs-number_of_product">Showing 1–9 of 12 results</div>
          <form action="#" class="cs-shop_filter_form">
            <select>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="cs-product_card cs_style_1">
              ...
              <div class="cs-product_info">
                <h2 class="cs-product_title"><a href="">Future AI robot toys</a></h2>
